...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-white/20 dark:bg-black/20 backdrop-blur-[40px] z-40 md:hidden flex justify-between items-center px-1 sm:px-3 pt-3 pb-[max(env(safe-area-inset-bottom),_1.5rem)] border-t border-white/50 dark:border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] rounded-t-[32px]">
      {tabs.map((tab) => {
