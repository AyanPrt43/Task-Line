...
const Header = ({ onMenuToggle }) => {
  ...
  return (
    <div className="relative z-50 w-full h-14 sm:h-16 bg-white/20 dark:bg-black/20 backdrop-blur-md flex gap-2 sm:gap-3 justify-end items-center px-3 sm:px-6 shrink-0 border-b md:border-b-0 md:border-l border-white/40 dark:border-white/10">
